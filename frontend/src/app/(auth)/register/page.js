...
export default function Register() {
    ...
    const industryOptions = ["Private Equity", "Venture Capital", "Management Consulting", "Family Office", "Corporate", "M&A", "Other"]
    ...
    const prevStep = () => {
        setActiveTabIndex((prev) => {
            ...
            if (newIndex < 0) {
                ...
                return prev; // wird nicht ausgeführt, da redirect den Reload auslöst
            }
            return newIndex;
        });
    };
