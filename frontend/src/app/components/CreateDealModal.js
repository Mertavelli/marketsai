...
export default function CreateDealModal({ createDealIsOpen, setCreateDealIsOpen, analysisData, isEditor = false }) {
        ...
        createDeal(
            ...
            },
            {
                onSuccess: (responseData) => {
                    ...
                    queryClient.invalidateQueries(["Deals", user?.id]);
                    setCreateDealIsOpen(false);

                    // 🔁 Weiterleitung zur Detailseite
                    router.push(`/deals/${responseData._id}`);
                },
                onError: () => {
    ...
    return (
        <div className="fixed inset-0 bg-black/30 z-40 flex items-center justify-center">
            <div className="bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] p-6 w-full max-w-md z-50 flex flex-col gap-4">
                ...
                <button
                    onClick={() => setCreateDealIsOpen(false)}
